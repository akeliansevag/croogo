...
<?php foreach ($nodes as $node): ?>
	<tr>
		...
		<td>
			<?php if(!empty($node['Node']['attachment'])):?>

				<?php echo $this->Html->link($this->Image->resize('/uploads/'.$node['Node']['attachment'], 100, 75), $this->Html->url('/uploads/'.$node['Node']['attachment'], true), array(
										'class' => 'thickbox',
										'escape' => false,
										'title' => 'Image'
									 ));
